/*
  ...
  - You are about to drop the column `day__id` on the `day_habits` table. All the data in the column will be lost.
  - You are about to drop the column `habit__id` on the `habit_week_days` table. All the data in the column will be lost.
